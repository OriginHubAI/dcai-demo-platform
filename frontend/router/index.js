...
const routes = [
  ...
  { path: '/knowledge-base/:id(.*)', name: 'knowledge-base-detail', component: () => import('../views/KnowledgeBaseDetailPage.vue') },
  { path: '/notebook', name: 'notebook', component: () => import('../views/NotebookPage.vue') },
