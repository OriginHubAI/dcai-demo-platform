...
SAMPLE_APPS = [
    ...
    },
    {
        ...
        'colorFrom': 'indigo',
        'colorTo': 'purple',
        'description': 'Notebook workspace for source-grounded QA, document ingestion, and multi-format knowledge outputs.',
        ...
        'tags': ['notebook', 'knowledge-base', 'rag', 'document'],
        'license': 'apache-2.0',
        'type': 'proxied',
        'integration': {'kind': 'open-notebook'},
    },
    {
